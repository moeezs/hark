        ...
        {cards.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center gap-[10px] text-hark-muted-light">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
              ...
              <path d="M12 21L18 27L28 13" stroke="#C4C0BA" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
            <p className="text-[13px]">All caught up</p>
          </div>
        ) : (
          <div className="pt-[18px] pb-10 flex flex-col gap-[10px] max-w-[600px]">
            {cards.map((card) => {
